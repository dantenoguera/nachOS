...
public:
    ...
    AddressSpace(OpenFile *executable_file, int id);
    ...
    Bitmap *inswap;
    void LoadFromSwap(int vpn, int frameAddr);
    void LoadFromExecutable(int vpn, int frameAddr);
    void ToSwap(int, unsigned);
    #ifdef LRU
    int Lru();
    #endif
    int Fifo();
