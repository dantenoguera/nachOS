...
public:
    ...
    // Delete a directory if there isn't anything inside
    ...
    // Add the file/directory to the list of open files with the name stating the absolute path
    char* FillPath(const char* path);
